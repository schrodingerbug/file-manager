...
Now,for actually running the thing.
If you download the .py file,you can run it with an IDE or Python 3.13.
But if you download the .exe file,you need to change it back into a .py file and then run it however you want.
